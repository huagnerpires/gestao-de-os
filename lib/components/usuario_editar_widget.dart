...
import 'usuario_editar_model.dart';
export 'usuario_editar_model.dart';

/// Create a component  cadastrar novo usuario
///
class UsuarioEditarWidget extends StatefulWidget {
  const UsuarioEditarWidget({super.key});

  @override
  State<UsuarioEditarWidget> createState() => _UsuarioEditarWidgetState();
}

class _UsuarioEditarWidgetState extends State<UsuarioEditarWidget> {
  late UsuarioEditarModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UsuarioEditarModel());

    _model.textFieldNOMEFocusNode ??= FocusNode();

    _model.textFieldCPFFocusNode1 ??= FocusNode();

    _model.textFieldCPFMask1 = MaskTextInputFormatter(mask: '###.###.###-##');
    ...
    _model.textFieldcontratoFocusNode ??= FocusNode();

    _model.textFieldEMAILFocusNode ??= FocusNode();

    _model.textFieldENDERECOFocusNode ??= FocusNode();

    _model.textFieldNUMFocusNode ??= FocusNode();
      ...
      child: StreamBuilder<List<UsuariosRecord>>(
        stream: queryUsuariosRecord(
          queryBuilder: (usuariosRecord) => usuariosRecord.where(
            'email',
            isEqualTo: FFAppState().emailpesquisa,
          ),
          singleRecord: true,
        ),
                          ...
                          children: [
                            Align(
                              ...
                              child: Container(
                                ...
                                child: Image.memory(
                                  _model.uploadedLocalFile_uploadDataQsf
                                          .bytes ??
                                      Uint8List.fromList([]),
                                  fit: BoxFit.cover,
                            ...
                            Align(
                              alignment: AlignmentDirectional(1.12, -0.92),
                              child: InkWell(
                                ...
                                onTap: () async {
                                  ...
                                  if (selectedMedia != null &&
                                    ...
                                    safeSetState(() => _model
                                        .isDataUploading_uploadDataQsf = true);
                                    ...
                                    try {
                                      ...
                                      _model.isDataUploading_uploadDataQsf =
                                          false;
                                    }
                        ...
                        children: [
                            ...
                            children: [
                              ...
                              TextFormField(
                                controller:
                                  ...
                                  text: functions.getMesMaiuscula(
                                ...
                                TextFormField(
                                  controller:
                                      _model.textFieldCPFTextController1 ??=
                                          TextEditingController(
                                    text: containerUsuariosRecord?.cnpj,
                                  ),
                                  ...
                                  validator: _model
                                      .textFieldCPFTextController1Validator
                                      .asValidator(context),
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                TextFormField(
                                  ...
                                  keyboardType: TextInputType.number,
                                  validator: _model
                                      .textFieldCPFTextController2Validator
                                      .asValidator(context),
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              TextFormField(
                                controller:
                                    _model.textFieldcontratoTextController ??=
                                        TextEditingController(
                                  text: functions.getMesMaiuscula(
                                      containerUsuariosRecord?.tipodecontrato),
                                ),
                                focusNode: _model.textFieldcontratoFocusNode,
                                autofocus: false,
                                textInputAction: TextInputAction.next,
                                obscureText: false,
                                decoration: InputDecoration(
                              ...
                              TextFormField(
                                controller:
                                    _model.textFieldEMAILTextController ??=
                                        TextEditingController(
                                  text: containerUsuariosRecord?.email,
                                ),
                              ...
                              TextFormField(
                                controller:
                                    _model.textFieldENDERECOTextController ??=
                                        TextEditingController(
                                  text: containerUsuariosRecord?.endereco,
                                ),
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    TextFormField(
                                      controller:
                                          _model.textFieldNUMTextController ??=
                                              TextEditingController(
                                        text: containerUsuariosRecord?.numero,
                                      ),
                                      focusNode: _model.textFieldNUMFocusNode,
                                      autofocus: false,
                                      textInputAction: TextInputAction.next,
                                      obscureText: false,
                                      decoration: InputDecoration(
                                  ...
                                  children: [
                                    ...
                                    TextFormField(
                                      controller: _model
                                          ...
                                          TextEditingController(
                                        text: containerUsuariosRecord?.baiiro,
                                      ),
                                      focusNode:
                              ...
                              TextFormField(
                                controller:
                                    _model.textFieldCITYTextController ??=
                                        TextEditingController(
                                  text: containerUsuariosRecord?.cidade,
                                ),
                              ...
                              TextFormField(
                                controller:
                                    _model.textFieldPHONETextController ??=
                                        TextEditingController(
                                  text: containerUsuariosRecord?.telefone,
                                ),
                              ...
                              TextFormField(
                                controller:
                                    _model.textFieldSENHATextController ??=
                                        TextEditingController(
                                  text: containerUsuariosRecord?.senha,
                                ),
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              TextFormField(
                                ...
                                focusNode:
                                    _model.textFieldCONFIRMASENHAFocusNode,
                                autofocus: false,
                    ...
                    FFButtonWidget(
                      onPressed: () async {
                        if (_model.textFieldSENHATextController.text ==
                            _model.textFieldCONFIRMASENHATextController.text) {
                          _model.emailexiste = await queryUsuariosRecordOnce(
                          ...
                          if (_model.emailexiste?.email != null &&
                              _model.emailexiste?.email != '') {
                            await showDialog(
                              context: context,
                              builder: (alertDialogContext) {
                                return AlertDialog(
                                  title: Text('ATENÇÃO'),
                                  content:
                                      Text('Este email já está sendo usado'),
                                  actions: [
                                    TextButton(
                                      onPressed: () =>
                            ...
                            if (_model.textFieldSENHATextController.text !=
                                _model.textFieldCONFIRMASENHATextController
                                    .text) {
                            ...
                            FFAppState().REFUSERS = UsuariosDadosStruct(
                              nome: _model.textFieldNOMETextController.text,
                              senha: _model
                                  .textFieldCONFIRMASENHATextController.text,
                              email: _model.textFieldEMAILTextController.text,
                              referencia: _model.emailexiste?.reference,
                            );
                            safeSetState(() {});
                            ...
                            await usuariosRecordReference
                              ...
                              photoUrl:
                                  '${_model.uploadedLocalFile_uploadDataQsf.originalFilename}',
                              senha: _model
                                  .textFieldCONFIRMASENHATextController.text,
                              empresa: _model.checkboxValue,
                              tipodecontrato:
                                  _model.textFieldcontratoTextController.text,
                              cnpj: _model.checkboxValue == true
                                  ? _model.textFieldCPFTextController1.text
                                  : _model.textFieldCPFTextController1.text,
                              uid: currentUserUid,
                              phoneNumber:
                                  _model.textFieldPHONETextController.text,
                              onesignal: currentUserEmail,
                              endereco:
                                  _model.textFieldENDERECOTextController.text,
                              numero: _model.textFieldNUMTextController.text,
                              telefone:
                                  _model.textFieldPHONETextController.text,
                              baiiro: _model.textFieldBAIRROTextController.text,
                              cidade: _model.textFieldCITYTextController.text,
                            ));
                            _model.joj = UsuariosRecord.getDocumentFromData(
                                createUsuariosRecordData(
                                  ...
                                  senha: _model
                                      ...
                                      .text,
                                  empresa: _model.checkboxValue,
                                  tipodecontrato: _model
                                      .textFieldcontratoTextController.text,
                                  cnpj: _model.checkboxValue == true
                                      ? _model.textFieldCPFTextController1.text
                                      : _model.textFieldCPFTextController1.text,
                                  uid: currentUserUid,
                                  ...
                                  onesignal: currentUserEmail,
                                  endereco: _model
                                      .textFieldENDERECOTextController.text,
                                  numero:
                                      _model.textFieldNUMTextController.text,
                                  telefone:
                                      _model.textFieldPHONETextController.text,
                                  baiiro:
