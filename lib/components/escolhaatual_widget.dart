...
import 'escolhaatual_model.dart';
export 'escolhaatual_model.dart';

/// Create a component   apagar ondens de serviço, editar o.s encerrada,
/// adicionar técnico, zerar pontuação, cadastrar serviços e pontos, liberar
/// acesso ao financeiro
///
class EscolhaatualWidget extends StatefulWidget {
  const EscolhaatualWidget({super.key});

  @override
  State<EscolhaatualWidget> createState() => _EscolhaatualWidgetState();
}

class _EscolhaatualWidgetState extends State<EscolhaatualWidget> {
  late EscolhaatualModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EscolhaatualModel());
                                              ...
                                              await showDialog<bool>(
                                                    ...
                                                    builder:
                                                      ...
                                                      return AlertDialog(
                                                        title: Text('ATENÇÃO!'),
                                                        content: Text(
                                                            'Deseja zerar a puntuação de todos os técnicos?'),
                                                        actions: [
                                                          TextButton(
                                                            onPressed: () =>
                                                                Navigator.pop(
                                              ...
                                              return Padding(
                                                padding:
                                                    MediaQuery.viewInsetsOf(
                                                        context),
                                                child:
                                                    CadastrarEquipamentoCustomwidgetWidget(),
                                              );
                                            },
                                          ).then(
                                              (value) => safeSetState(() {}));
                                            ...
                                            child: Padding(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  Text(
                                                    'Cadatrar/Editar/excluir equipamento',
                                                    textAlign: TextAlign.center,
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .titleSmall
