...
import 'chat_online_model.dart';
export 'chat_online_model.dart';

class ChatOnlineWidget extends StatefulWidget {
  const ChatOnlineWidget({
    super.key,
    required this.email,
  });
  ...
  static String routeName = 'CHAT_ONLINE';
  static String routePath = '/chatOnline';

  @override
  State<ChatOnlineWidget> createState() => _ChatOnlineWidgetState();
}

class _ChatOnlineWidgetState extends State<ChatOnlineWidget> {
  late ChatOnlineModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ChatOnlineModel());
